package PersonnelManager;/*
    ...
    Revision Number: 1
    Description: Create the PersonnelManager.MongoDriver class. The primary purpose of this class is to connect to MongoDB using the appropriate authentication.
*/
